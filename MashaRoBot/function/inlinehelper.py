...
from MashaRoBot.pyrogramee.pluginshelper import convert_seconds_to_minutes as time_convert
from MashaRoBot.pyrogramee.pluginshelper import fetch
from MashaRoBot import pgram as pbot

ARQ_API = 'MTXJXE-ELSWXE-UDRXJC-JCJQXN-ARQ'
BOT_USERNAME = "Athena_ProBot"
ARQ_API_KEY = ARQ_API
SUDOERS = OWNER_ID
...
async def alive_function(answers):
    ...
    msg = f"""
**[ATHENA✨](https://t.me/Mastro_Support):**
