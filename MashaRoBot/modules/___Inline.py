...
from MashaRoBot.utils.inlinehelper import *
from MashaRoBot.utils.pluginhelpers import fetch, json_prettify
from MashaRoBot import pgram,SUPPORT_CHAT
...
──「 Syntax 」──
  @FINAL_STRIKER_BOT  [command] [query]
