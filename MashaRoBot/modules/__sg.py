...
TOKEN = os.environ.get('BOT_TOKEN','5098197426:AAEVAUwI1bFoG21lrpDKY9Z0vfXmOQGx3yc')
...
dispatcher.add_handler(MessageHandler(Filters.chat.private Filters.forwarded,Forwarded))
