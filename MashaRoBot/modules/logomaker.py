...
async def lego(event):
 ...
 try:
    ...
    await tbot.send_file(event.chat_id, fname2, caption="Made By @Athena_support ⚡️")
   ...
   await event.reply(f'Error Go to Help From  @Athena_support, {e}')
...
async def lego(event):
 ...
 try:
    ...
    await tbot.send_file(event.chat_id, fname2, caption="Made By @Athena_support")
